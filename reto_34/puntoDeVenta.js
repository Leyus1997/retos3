calcularValorTotal = function(){
    ...
    let valorIVA;
    let valorTotal;
    //calculo del valor total en compras
    ...
    //porcentaje=recuperarInt("txtPorcentajeDescuento");
    ...
    let resumen="Valor a pagar por "+cantidad+" "+nombreProducto+" con "+" %"+" de descuento: USD "+valorTotal;
